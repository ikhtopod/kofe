...
void ScreenSize::Update(ScreenSize other) { swap(*this, other); }

int32_t ScreenSize::GetWidth() const { return m_width; }

void ScreenSize::SetWidth(const int32_t width) { m_width = width; }

int32_t ScreenSize::GetHeight() const { return m_height; }

void ScreenSize::SetHeight(const int32_t height) { m_height = height; }
